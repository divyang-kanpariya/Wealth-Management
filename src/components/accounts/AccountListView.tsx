...
import { AccountsPageData, AccountWithTotals } from '@/lib/server/data-preparators';
          ...
          <div className="space-y-4">
            ...
            {(selectedAccount?.investmentCount ?? 0) > 0 ? (
              <Alert
                ...
                message={`This account has ${selectedAccount?.investmentCount ?? 0} linked investment${(selectedAccount?.investmentCount ?? 0) !== 1 ? 's' : ''}. Please reassign or delete these investments first.`}
              />
            ) : (
              ...
              {selectedAccount.investments && selectedAccount.investments.length > 0 && (
                <div>
                  ...
                  <div className="space-y-2">
                    {selectedAccount.investments.map((investment: any) => (
