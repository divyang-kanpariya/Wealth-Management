      ...
      render: (_, item) => (
        <div className="min-w-0">
          ...
          <div className="text-xs text-gray-500 truncate">
            {item.investment?.type?.replace('_', ' ') || 'Unknown Type'}
  ...
  const tabs: Tab[] = [
    {
      ...
      content: (
        <CompactTable
          ...
          rowKey={(item) => item.investment?.id || `gainer-${Math.random()}`}
          variant="minimal"
          showHeader={false}
          maxHeight="200px"
    ...
    },
    {
      ...
      content: (
        <CompactTable
          data={topLosers}
          columns={performanceColumns}
          rowKey={(item) => item.investment?.id || `loser-${Math.random()}`}
          variant="minimal"
          showHeader={false}
          maxHeight="200px"
    ...
    },
    {
      ...
      content: (
        <CompactTable
          ...
          rowKey={(item) => item.investment?.id || `best-${Math.random()}`}
          variant="minimal"
          showHeader={false}
          maxHeight="200px"
    ...
    },
    {
      ...
      content: (
        <CompactTable
          ...
          columns={percentageColumns}
          rowKey={(item) => item.investment?.id || `worst-${Math.random()}`}
          variant="minimal"
          showHeader={false}
          maxHeight="200px"
